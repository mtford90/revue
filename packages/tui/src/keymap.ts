...
const KEYMAP_DEF = [
	...
	{
		id: "previous-page",
		description: "Previous chapter (prologue is page one)",
		keys: ["["],
		context: "global",
		section: "Navigation",
	},
	...
	{
		id: "line-up",
		description: "Scroll up one visual row without moving the line cursor",
	...
	{
		id: "line-down",
		description: "Scroll down one visual row without moving the line cursor",
		keys: ["down", "ctrl+n", "ctrl+e"],
		displayKeys: ["down"],
		context: "page",
		section: "Scrolling",
	},
	{
		id: "previous-source-line",
		description: "Move the review line cursor up",
		keys: ["k"],
		context: "page",
		section: "Review",
	},
	{
		id: "next-source-line",
		description: "Move the review line cursor down",
		keys: ["j"],
		context: "page",
		section: "Review",
	},
	...
	{
		id: "open-editor",
		description: "Open the selected line in $VISUAL or $EDITOR",
		keys: ["e"],
		context: "page",
		section: "Review",
	},
...
const FOOTER_HINTS: readonly {
	...
	{ context: "page", ids: ["next-source-line", "previous-source-line"], label: "line" },
	{ context: "page", ids: ["line-down", "line-up"], label: "scroll" },
	{ context: "page", ids: ["select-lines"], label: "select" },
